...
/**
 * Abstract Activity for AngelForestOpenGL Engine.
 * Those app that wants to use AngelForestOpenGL Engine must be extended
 * from this class.
 *
 * The only thing extended class must do is to create Renderer class,
 * and set it at setRenderer method.
 *
...
//        renderer = new FlickDefenderRenderer(this);
    ...
    /**
     * set renderer.
     * renderer must be implemented with AngelforestRenderer.
     *
     */
